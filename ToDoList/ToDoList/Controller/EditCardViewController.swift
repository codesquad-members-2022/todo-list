...
class EditCardViewController: UIViewController {
    ...
    private func setBodyTextViewInitialState() {
        ...
        bodyTextView.text = Constants.bodyTextViewDefaultText
        bodyTextView.textColor = Constants.bodyTextViewDefaultPlaceholderColor
    ...
    private func setButtonInitialState() {
        ...
        addButton.backgroundColor = Constants.addButtonDefaultColor
        addButton.setTitleColor(Constants.addButtonTitleDefaultColor, for: .disabled)
    }
    ...
    @IBAction func addButtonTouched(_ sender: UIButton) {
        ...
        let userInfo = [Constants.userInfoKeys.addedData: newData]
        
        NotificationCenter.default.post(name: Constants.NotificationNames.didAddNewData, object: self, userInfo: userInfo)
...
extension EditCardViewController: UITextViewDelegate {
    func textViewDidBeginEditing(_ textView: UITextView) {
        if textView.textColor == Constants.bodyTextViewDefaultPlaceholderColor {
            textView.text = nil
            textView.textColor = Constants.bodyTextViewDefaultTextColor
        }
    }
