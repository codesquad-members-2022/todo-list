...
VALUES ('userId1', 1, 'taskTitle1', 1, 1, now(), false);

INSERT INTO activity_log (user_id, action, task_title, from_status, to_status, created_at, read_yn)
VALUES ('userId2', 2, 'taskTitle2', 1, 1, now(), false);

INSERT INTO activity_log (user_id, action, task_title, from_status, to_status, created_at, read_yn)
VALUES ('userId3', 3, 'taskTitle3', 1, 1, now(), false);

INSERT INTO activity_log (user_id, action, task_title, from_status, to_status, created_at, read_yn)
VALUES ('userId1', 4, 'taskTitle4', 1, 2, now(), false);

INSERT INTO activity_log (user_id, action, task_title, from_status, to_status, created_at, read_yn)
VALUES ('userId2', 1, 'taskTitle5', 2, 2, now(), false);

INSERT INTO activity_log (user_id, action, task_title, from_status, to_status, created_at, read_yn)
VALUES ('userId3', 2, 'taskTitle6', 2, 2, now(), false);

INSERT INTO activity_log (user_id, action, task_title, from_status, to_status, created_at, read_yn)
VALUES ('userId1', 3, 'taskTitle7', 2, 2, now(), false);

INSERT INTO activity_log (user_id, action, task_title, from_status, to_status, created_at, read_yn)
VALUES ('userId2', 4, 'taskTitle8', 2, 3, now(), false);

INSERT INTO activity_log (user_id, action, task_title, from_status, to_status, created_at, read_yn)
VALUES ('userId3', 1, 'taskTitle9', 3, 3, now(), false);

INSERT INTO activity_log (user_id, action, task_title, from_status, to_status, created_at, read_yn)
VALUES ('userId1', 2, 'taskTitle10', 3, 3, now(), false);

INSERT INTO activity_log (user_id, action, task_title, from_status, to_status, created_at, read_yn)
VALUES ('userId2', 3, 'taskTitle11', 3, 3, now(), false);

INSERT INTO activity_log (user_id, action, task_title, from_status, to_status, created_at, read_yn)
VALUES ('userId3', 4, 'taskTitle12', 3, 3, now(), false);

INSERT INTO activity_log (user_id, action, task_title, from_status, to_status, created_at, read_yn)
VALUES ('userId1', 4, 'taskTitle13', 1, 1, now(), false);

INSERT INTO activity_log (user_id, action, task_title, from_status, to_status, created_at, read_yn)
VALUES ('userId2', 4, 'taskTitle14', 1, 2, now(), false);

INSERT INTO activity_log (user_id, action, task_title, from_status, to_status, created_at, read_yn)
VALUES ('userId3', 4, 'taskTitle15', 2, 3, now(), false);

INSERT INTO activity_log (user_id, action, task_title, from_status, to_status, created_at, read_yn)
VALUES ('userId1', 4, 'taskTitle16', 3, 3, now(), false);
