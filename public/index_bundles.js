...
/* harmony export */   "TODO_LIST_URL": () => (/* binding */ TODO_LIST_URL),
...
var TODO_LIST_URL = "http://localhost:3000/todoListData";
...
/* harmony import */ var _views_columnsView_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./views/columnsView.js */ "./src/js/views/columnsView.js");
/* harmony import */ var _views_cardView_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./views/cardView.js */ "./src/js/views/cardView.js");
/* harmony import */ var _views_newCardView_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./views/newCardView.js */ "./src/js/views/newCardView.js");
/* harmony import */ var _store_store__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./store/store */ "./src/js/store/store.js");
...
var controller = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(views) {
    var headerView, mainView, todoListData, store;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            headerView = views.headerView, mainView = views.mainView;
            _context.next = 3;
            return (0,_utils_util_js__WEBPACK_IMPORTED_MODULE_4__.fetchData)(_constants_constant_js__WEBPACK_IMPORTED_MODULE_3__.TODO_LIST_URL);

          case 3:
            todoListData = _context.sent;
            store = (0,_store_store__WEBPACK_IMPORTED_MODULE_8__.createStore)();
            store.setStore('main', todoListData);
            (0,_views_columnsView_js__WEBPACK_IMPORTED_MODULE_5__.insertColumns)(mainView, store.getStore('main'));
            (0,_views_cardView_js__WEBPACK_IMPORTED_MODULE_6__.insertAllCardToColumn)(mainView, store.getStore('main'));
            (0,_utils_util_js__WEBPACK_IMPORTED_MODULE_4__.appendElementsToParent)(document.body, headerView, mainView);
            (0,_views_newCardView_js__WEBPACK_IMPORTED_MODULE_7__.onAddBtnClick)();
...
var createStore = function createStore() {
  ...
  var getStore = function getStore(elementName) {
    return store[elementName];
  };

  var setStore = function setStore(elementName, item) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "appendElementsToParent": () => (/* binding */ appendElementsToParent),
...
var appendElementsToParent = function appendElementsToParent(parent) {
...
var insertCardToColumn = function insertCardToColumn(column) {
  var parent = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : document;
  var columnElement = parent.querySelector(".".concat(column.className));
  var cardList = columnElement.querySelector('.task__cards');
  var taskCount = columnElement.querySelector('.title-column__title__count');
  taskCount.textContent = column.total;
  column.tasks.forEach(function (task) {
    cardList.insertAdjacentHTML('beforeend', createCardTemplate(task));
  });
};
var insertAllCardToColumn = function insertAllCardToColumn(parent, store) {
  store.forEach(function (column) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "insertColumns": () => (/* binding */ insertColumns)
/* harmony export */ });
...
/* harmony import */ var _constants_constant_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../constants/constant.js */ "./src/js/constants/constant.js");





var insertColumns = function insertColumns(parentElement, store) {
  var columns = store.map(function (column) {
...
var createColumnTemplate = function createColumnTemplate(className, title) {
  return "\n  <div class=\"column ".concat(className, "\">\n    <div class=\"title-column\">\n      <div class=\"title-column__title\">\n        <div class=\"title-column__title__text\">").concat(title, "</div>\n        <div class=\"title-column__title__count\">0</div>\n      </div>\n      <div class=\"title-column__btn\">\n        <div class=\"title-column__btn__add\" data-classname=").concat(className, ">\n          ").concat(_constants_constant_js__WEBPACK_IMPORTED_MODULE_4__.icons.add, "\n        </div>\n        <div class=\"title-column__btn__delete\">\n          ").concat(_constants_constant_js__WEBPACK_IMPORTED_MODULE_4__.icons["delete"], "\n        </div>\n      </div>\n    </div>\n    <ul class=\"task__cards\">\n    </ul>\n  </div>\n  ");
};

/***/ }),

/***/ "./src/js/views/headerView.js":
/*!************************************!*\
  !*** ./src/js/views/headerView.js ***!
  \************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var createHeaderElement = function createHeaderElement() {
  var headerTemplate = "\n    <div class=\"header__title\">TO-DO LIST</div>\n    <div class=\"header__layer-button\">".concat(_constants_constant_js__WEBPACK_IMPORTED_MODULE_0__.icons.menu, "</div>\n    ");
...
/* harmony export */ });
var createMainElement = function createMainElement() {
...
var handleAddBtnClick = function handleAddBtnClick(mainElement, target, store) {
  ...
  var className = target.closest(".title-column__btn__add").dataset.classname;
  var column = mainElement.querySelector(".".concat(className));
  var cardList = column.querySelector('.task__cards');
...
var onResizeTextArea = function onResizeTextArea(textArea) {
...
var toggleNewCard = function toggleNewCard(cardList) {
  var newCard = cardList.querySelector('.new-card');
...
/* harmony import */ var _views_headerView_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./views/headerView.js */ "./src/js/views/headerView.js");
/* harmony import */ var _views_mainView_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./views/mainView.js */ "./src/js/views/mainView.js");
...
(function () {
  var headerView = (0,_views_headerView_js__WEBPACK_IMPORTED_MODULE_1__.createHeaderElement)();
  var mainView = (0,_views_mainView_js__WEBPACK_IMPORTED_MODULE_2__.createMainElement)();
  var views = {
    headerView: headerView,
    mainView: mainView
  };
  (0,_controller__WEBPACK_IMPORTED_MODULE_3__.controller)(views);
})();
})();

/******/ })()
;
//# sourceMappingURL=index_bundles.js.map