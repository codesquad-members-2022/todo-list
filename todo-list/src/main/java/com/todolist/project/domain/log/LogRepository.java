...
public class LogRepository {
    private static final String LOG_SELECT_SQL = "SELECT title, current_status, prev_status, action_status, action_time FROM LOG";
    private static final String LOG_INSERT_SQL = "INSERT INTO LOG (title, current_status, prev_status, action_status, action_time) VALUES (:title, :current_status, :prev_status, :action_status, :action_time)";
    ...
    public List<LogListDto> findAll() {
        return namedParameterJdbcTemplate.query(LOG_SELECT_SQL,
                (rs, rowNum) -> {
                    ...
                    return new LogListDto(title, prev_status, current_status, actionStatus, action_time);
                }
        );
    }
